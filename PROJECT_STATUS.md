...
**Last Updated:** 2026-05-09 22:24:04

## Recent Changes
- **v4.0.6**: Changed result report rows to a stacked label/value/note layout so mobile detail links stay inside the card and remain tappable.
